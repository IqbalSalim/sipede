<div>
    <form wire:submit.prevent='update' novalidate>
        ...
        <div class="fixed inset-0 z-50 flex justify-center w-full py-4 bg-black bg-opacity-40" x-show="modalEdit">
            ...
            <div @click.away="modal = false" x-show="modalEdit" x-transition:enter.duration.500ms
                ...
                <div class="flex flex-col flex-1 px-4 py-2 overflow-auto h-96">
                    <div class="flex flex-col space-y-4 md:items-center md:flex-row md:space-x-4">
                        ...
                        <div class="flex-1 mt-4">
                            ...
                            <x-input wire:model.defer="judul" class="block w-full mt-1 text-sm" type="text" name="judul"
                                autofocus />
                        ...
                        <div class="mt-4">
                            ...
                            <x-input wire:model.defer="penulis" class="block w-full mt-1 text-sm" type="text"
                                name="penulis" autofocus />
                            <span class="text-sm text-danger">
                                @error('penulis')
                                    {{ $message }}
                                @enderror
