                        ...
                        @if ($rkpdesa != null)
                            <div class="grid grid-cols-2 gap-3">
                                <div class="mt-2">
                                    ...
                                    <x-input wire:model="kode_rekening" id="kode_rekening"
                                        class="block w-full mt-1 text-sm" type="text" name="kode_rekening" autofocus />
                                ...
                                <div class="mt-2">
                                    ...
                                    <x-input id="sasaran" wire:model="sasaran" class="block w-full mt-1 text-sm"
                                ...
                                <div class="mt-2">
                                    ...
                                    <x-input id="jumlah" wire:model="jumlah" class="block w-full mt-1 text-sm"
                                        type="number" min="0" name="jumlah" autofocus />
                                    <span class="text-sm text-danger">
                                        @error('jumlah')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="mt-2">
                                    ...
                                    <x-input id="sumber" wire:model="sumber" class="block w-full mt-1 text-sm"
                                        type="text" name="sumber" autofocus />
                                    <span class="text-sm text-danger">
                                        @error('sumber')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="mt-2">
                                    ...
                                    <x-input id="rencana" wire:model="rencana" class="block w-full mt-1 text-sm"
                                        type="text" name="rencana" autofocus />
                                    <span class="text-sm text-danger">
                                        @error('rencana')
                                            {{ $message }}
                                        @enderror
                                ...
                                <td class="px-2 md:px-6">
                                    <div class="flex flex-row items-center space-x-4">
                                        ...
                                        <button type="button" class="text-xs btn-warning"
                                            wire:click.prevent="buttonDetail({{ $row->id }})"
