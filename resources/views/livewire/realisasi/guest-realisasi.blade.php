<div>
    <div class="bg-gray-100" x-cloak x-data="{ modalDetail: false }" x-on:close-detail.window='modalDetail=false'>
        <livewire:realisasi.detail-realisasi>
                                        ...
                                        <td class="px-2 md:px-6">
                                            <div class="flex flex-row items-center space-x-4">
                                                <button type="button" class="text-xs btn-primary"
                                                    wire:click="$emit('getDetailRealisasi', {{ $row->id }}, {{ "'" . $row->status_kegiatan . "'" }})"
