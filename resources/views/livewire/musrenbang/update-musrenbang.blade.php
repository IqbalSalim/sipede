<div>
    <form wire:submit.prevent='update'>
        @csrf
        <div class="fixed inset-0 z-50 flex justify-center w-full py-16 bg-black bg-opacity-40" x-show="modalEdit">

            <!-- A basic modalEdit dialog with title, body and one button to close -->

            <div x-show="modalEdit" x-transition:enter.duration.500ms x-transition:leave.duration.400ms
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    <h3 class="text-lg font-medium leading-6 text-gray-900">
                        Form Musrenbang Desa
                    </h3>

                    <div class="mt-2">
                        <p class="text-sm leading-5 text-primary">
                            silahkan isi data Musrenbang Desa
                        </p>
                    </div>
                </div>

                <div class="flex flex-col flex-1 px-4 py-2 overflow-auto h-96">
                    <input type="hidden" wire:model.defer="musrenbang_id">
                    <!-- Name -->
                    <div class="mt-4">
                    ...
                    <div class="mt-4">
                        ...
                        <input wire:model.defer="filename" id="filename"
                ...
                <div>
                    <div class="flex items-center justify-between mt-8">
                        ...
                        <button @click="modalEdit = false" type="button" class="btn-secondary">
                            Close
                        </button>
                    </div>
                </div>
