<div>
    <div class="bg-gray-100" x-data="{ modalCreate: false, modalShow: false, modalEdit: false }"
        ...
        <livewire:musrenbang.create-musrenbang></livewire:musrenbang.create-musrenbang>
        <livewire:musrenbang.update-musrenbang></livewire:musrenbang.update-musrenbang>
        <livewire:musrenbang.show-musrenbang></livewire:musrenbang.show-musrenbang>
                                ...
                                <tr>
                                    ...
                                    <td class="px-2 md:px-6">
                                        <div class="flex flex-row items-center space-x-4">
                                            <button wire:click.prevent="$emit('getfilePdf', {{ $musrenbang->id }})"
                                                @click="modalShow = true" type="button"
                                                class="text-xs btn-primary">lihat</button>
                                            <button wire:click.prevent="$emit('getMusrenbang', {{ $musrenbang->id }})"
                                                @click="modalEdit = true" type="button"
                                                class="text-xs btn-success">edit</button>
                                            <button wire:click.prevent="alertConfirm({{ $musrenbang->id }})"
                                                type="button" class="text-xs btn-danger">hapus</button>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
